  ...
  return (
    <Layout>
      <TerminalLayout
        ...
        contentText={`This is my portfolio site where you can find a bit more information about myself, and also take a look at some of my miscellaneous projects.
        Currently on the second iteration of my portfolio site, I also intend to experiment a 3D version utilizing Babylon.js.
        `}
        listObjects={[

...
category: ["All","C++"]
importance: 9
projectName: "Current Hobby Project"
thumbnailImage: ../images/projectimages/Game scene.png
---

<AsciiText bClassStyling={true}>{"Steady"}</AsciiText>
<AsciiText bClassStyling={true}>{"Inprogress Project"}</AsciiText>
...
So that it won't just become a prototype. I am using C++ in UE4 and I am creating this for Quest & Quest 2 devices, as I do own a Quest to debug with.

...
category: ["All","C++"]
importance: 3 
projectName: "Maze Generation UE4"
thumbnailImage: ../images/projectimages/Random generated maze structure.png
---

<AsciiText bClassStyling={true}>{"Maze Generation"}</AsciiText>
<AsciiText bClassStyling={true}>{"UE4 C++"}</AsciiText>

<VideoFrame 
videoSrcURL={"https://www.youtube.com/embed/3jcF_slWnDU?rel=0"}
videoTitle={"Maze generation in UE4 using C++"}
/>
In this video you can see the maze generation in action.
<br/>
<br/>
